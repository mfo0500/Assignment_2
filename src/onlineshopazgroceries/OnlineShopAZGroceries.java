...
public class OnlineShopAZGroceries implements IsValid {
    ...
    private SignInServiceModel signInService;
...
////                            SignInServiceModel s = new SignInServiceModel();
...
// The public ListOfGroceries getGroceryList() returns the OnlineShopAZGroceries object's groceryList in the form of a ListOfGroceries object.
 ...
 // CheckoutService object (checkout).
  ...
  // The public SignInService getSignInService() returns the OnlineShopAZGroceries object's signInService in the form of a SignInService object.
    public SignInServiceModel getSignInService() {
 ...
 // SignInService object (signInService).
    public void setSignInService(SignInServiceModel signInService) {
...
//                // open store             // the user is directed to the public void openStore(OnlineShopAZGroceries shop) function
//            }
//            if (shop.getState().equals("no results")) { // if the state of the OnlineShopAZGroceries object is "no results" and the user presses /
//               // display search                   // the user is directed to the  public void search(OnlineShopAZGroceries shop) function
//            }
...
//               // display search list                         // the user is directed to the public void searchList(OnlineShopAZGroceries shop)) function
//            }
...
//               // display cart options                 // the user is directed to the public void addCartChoice(OnlineShopAZGroceries shop) function
//            }
...
//                // display sign in process  // the user is directed to the public void signInProcess(OnlineShopAZGroceries shop) function
//            }
//        }
//        try {
